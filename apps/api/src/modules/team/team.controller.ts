...
export const getTeamTracker = async (req: AuthenticatedRequest, res: Response) => {
  let whereClause: any = { role: 'MR', active: true };
...
export const getMrDetail = async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
